<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="ASBWeb.About" %>
                            ...
                            <div class="container-fluid">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-1">
                                        <div class="logo">
                                            <!-- logo-1 -->
                                            <a href="Default.aspc" class="big-logo">
                                                <img src="assets/img/logo/Automated_Smart_Blinds_Logo_Header_Test_White.png" alt=""/></a>
                                            <!-- logo-2 -->
                                            <a href="Default.aspx" class="small-logo">
                                                <img src="assets/img/logo/Automated_Smart_Blinds_Logo_Header_blinds2_small.png" alt=""/></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="section-tittle section-tittle5 mb-50">
                                    <div class="front-text">
                                        <h2 class="">Contact OIT</h2>
                                    </div>
                                    <span class="back-text">Contact OIT</span>
                                </div>
                            </div>
