<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ASBWeb.Default" %>
                            ...
                            <div class="col-lg-12">
                                <div class="section-tittle mb-55">
                                    <div class="front-text">
                                        <h2 class="">Demo Controls</h2>
                                    </div>
                                    <span class="back-text">Demo Controls</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="service-img">
                                        ...
                                        <p>
                                            ...
                                            &nbsp;&nbsp;&nbsp; Enter numeric value from 0(closed) to 100(open)&nbsp;&nbsp;&nbsp;
                                                            <asp:TextBox runat="server" ID="txtNewBlindHorizontal" Enabled="false"></asp:TextBox>
                                            &nbsp;&nbsp;&nbsp; 
                                        </p>
                                        <p>
                                            Select Preconfigured setting &nbsp;&nbsp;&nbsp;
                                                            <asp:DropDownList ID="ddlBlindsPreConH" runat="server">
