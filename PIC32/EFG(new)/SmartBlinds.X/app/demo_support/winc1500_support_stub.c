...
#if defined(USING_TCP_SERVER) || defined(USING_TCP_CLIENT) || defined(USING_PROVISION_HTTP) || defined(USING_PROVISION_AP) || defined(USING_MAC_ADDRESS) || defined(USING_SSL_CONNECT) \
